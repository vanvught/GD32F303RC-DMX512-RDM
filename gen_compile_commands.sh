...
INCLUDE_PATHS="$INCLUDE_PATHS -I/Users/arjanvanvught/Library/xPacks/@xpack-dev-tools/arm-none-eabi-gcc/13.2.1-1.1.1/.content/arm-none-eabi/include/c++/13.2.1"
INCLUDE_PATHS="$INCLUDE_PATHS -I/Users/arjanvanvught/Library/xPacks/@xpack-dev-tools/arm-none-eabi-gcc/13.2.1-1.1.1/.content/arm-none-eabi/include/c++/13.2.1/arm-none-eabi/thumb/nofp"
...
find . -name '*.cpp' | while read file; do
  ...
  echo "    \"command\": \"clang++ -std=c++20 --target=arm-none-eabi -ffreestanding -nostdlib -nostdinc++ $INCLUDE_PATHS $DEFINES $file\"," >> compile_commands.json
